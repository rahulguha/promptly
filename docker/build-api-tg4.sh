...
echo "Building Promptly API for Graviton..."
...
GOOS=linux GOARCH=arm64 go build -o docker/promptly-api-tg4 cmd/promptly/main.go
...
echo "✅ Binary built successfully: docker/promptly-api-tg4"
